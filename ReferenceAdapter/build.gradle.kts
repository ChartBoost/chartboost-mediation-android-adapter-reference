...
android {
    namespace = "com.chartboost.helium.referenceadapter"
    compileSdk = 33
    ...
    defaultConfig {
        ...
        android.defaultConfig.versionName = System.getenv("VERSION_OVERRIDE") ?: "4.1.0.0.0"
        buildConfigField("String", "HELIUM_REFERENCE_ADAPTER_VERSION", "\"${android.defaultConfig.versionName}\"")
...
artifactory {
    ...
    publish {
        ...
        defaults {
            publications("ReferenceAdapter", "aar")
    ...
    publishing {
        publications {
            register<MavenPublication>("remoteRelease") {
                ...
                pom {
                    name.set("Helium Adapter Reference")
